...
export function Footer() {
  return (
    <footer className="border-t border-slate-200/80 bg-white/90 py-8 text-slate-600">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-semibold uppercase tracking-wider text-slate-800 font-mono">
              Telemetry Feeds
            </h4>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li>
                <Link href="/astronauts" className="hover:text-cyan-600 transition-colors">
                  Astronauts &amp; Space Station Roster
                </Link>
              </li>
              <li>
                <Link href="/history" className="hover:text-cyan-600 transition-colors">
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-4 border-t border-slate-200 pt-6 text-xs text-slate-500 sm:flex-row font-mono">
