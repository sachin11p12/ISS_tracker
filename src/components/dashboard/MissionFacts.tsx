    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {facts.map((fact, idx) => {
          ...
          return (
            <Card key={idx} className="border-slate-200 bg-white/80 hover:border-slate-300 transition-all">
              <div className="flex items-start gap-3">
                <div className={`mt-0.5 rounded-xl bg-slate-100 p-2.5 border border-slate-200 ${fact.color}`}>
